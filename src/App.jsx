...
function TermsModal({ onClose }) {
  const sections = [
    ...
    { title: '3. Accuracy, Completeness, and Reliability of Data', body: 'WHILE WE STRIVE TO PROVIDE ACCURATE AND TIMELY INFORMATION, THE COMPANY MAKES NO REPRESENTATIONS, WARRANTIES, OR GUARANTEES, EXPRESS OR IMPLIED, REGARDING THE ACCURACY, COMPLETENESS, CURRENCY, RELIABILITY, OR AVAILABILITY OF ANY DATA, REPORT, SCORE, ESTIMATE, OR ANALYSIS PRESENTED ON THE PLATFORM. Real estate markets are inherently dynamic and subject to rapid change. Data may be sourced from third parties, which may contain errors, omissions, or be outdated. Algorithmic estimates and AI-generated verdicts are predictive models based on available data and are inherently approximations; they may differ materially from actual market conditions or professional appraisals. The Company explicitly disclaims all liability for any errors, inaccuracies, or omissions in the Platform content, and for any loss or damage arising from your reliance on such content.' },
    { title: '4. AI-Generated Content Disclaimer', body: 'The Platform extensively utilizes advanced artificial intelligence (AI) technologies to generate various forms of content, including but not limited to textual reports, analyses, property valuations, investment scores, and market insights. You acknowledge and understand that AI-generated content is experimental, can be prone to errors, inaccuracies, logical fallacies (often referred to as "hallucinations"), or may be based on outdated information. AI verdicts and investment scores are statistical probabilities or estimations and are NOT predictive guarantees of future market performance or investment returns. You expressly acknowledge that AI-generated content should not be considered a substitute for human professional judgment or a sole basis for any critical decision. The Company shall not be liable for any direct, indirect, incidental, consequential, or punitive damages, or any other loss, arising from or in connection with your use of or reliance on any AI-generated content.' },
    { title: '5. Limitation of Liability', body: 'TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL THE COMPANY, ITS AFFILIATES, DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, SUPPLIERS, OR LICENSORS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA, OR OTHER INTANGIBLE LOSSES (EVEN IF THE COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), ARISING OUT OF OR IN CONNECTION WITH YOUR ACCESS TO, USE OF, OR INABILITY TO USE THE PLATFORM. THIS INCLUDES DAMAGES RESULTING FROM ERRORS, OMISSIONS, INTERRUPTIONS, DELETION OF FILES, VIRUSES, DEFECTS, DELAYS IN OPERATION OR TRANSMISSION, OR ANY FAILURE OF PERFORMANCE. THE TOTAL CUMULATIVE LIABILITY OF THE COMPANY TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THESE TERMS OR YOUR USE OF THE PLATFORM SHALL NOT EXCEED THE GREATER OF: (A) THE TOTAL AMOUNT PAID BY YOU TO THE COMPANY FOR ACCESS TO THE PLATFORM IN THE THREE (3) MONTHS IMMEDIATELY PRECEDING THE EVENT GIVING RISE TO THE CLAIM; OR (B) FIFTY CANADIAN DOLLARS (CAD $50.00).' },
    { title: '6. Disclaimer of Warranties', body: 'THE PLATFORM IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS, WITHOUT ANY WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PERMISSIBLE PURSUANT TO APPLICABLE LAW, THE COMPANY EXPRESSLY DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, AND THOSE ARISING FROM COURSE OF DEALING OR USAGE OF TRADE. THE COMPANY DOES NOT WARRANT THAT THE PLATFORM WILL BE UNINTERRUPTED, ERROR-FREE, SECURE, OR FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. WE DO NOT WARRANT THAT THE RESULTS THAT MAY BE OBTAINED FROM THE USE OF THE PLATFORM WILL BE ACCURATE OR RELIABLE, OR THAT THE QUALITY OF ANY PRODUCTS, SERVICES, INFORMATION, OR OTHER MATERIAL PURCHASED OR OBTAINED BY YOU THROUGH THE PLATFORM WILL MEET YOUR EXPECTATIONS.' },
    { title: '7. User Obligations, Account Security, and Prohibited Conduct', body: 'You agree to use the Platform strictly for lawful purposes and in accordance with these Terms. You are solely responsible for maintaining the confidentiality of your account credentials, including your password, and for all activities that occur under your account. You agree to notify us immediately of any unauthorized use of your account. You shall not: (a) engage in any activity that interferes with or disrupts the Platform (or the servers and networks which are connected to the Platform); (b) attempt to gain unauthorized access to any portion or feature of the Platform, or any other systems or networks connected to the Platform; (c) scrape, crawl, or systematically extract data from the Platform without our express written permission; (d) reproduce, duplicate, copy, sell, resell, or exploit any portion of the Platform, use of the Platform, or access to the Platform for any commercial purpose without our express written consent; (e) reverse engineer, decompile, or disassemble any aspect of the Platform; (f) impersonate any person or entity, or falsely state or otherwise misrepresent your affiliation with a person or entity; (g) upload, post, email, transmit, or otherwise make available any content that is unlawful, harmful, threatening, abusive, harassing, tortious, defamatory, vulgar, obscene, libelous, invasive of another\'s privacy, hateful, or racially, ethnically, or otherwise objectionable; (h) use the Platform to transmit any computer viruses, worms, or any software intended to damage or alter a computer system or data. Any violation of these provisions may result in immediate termination of your account, denial of access to the Platform, and potential legal action.' },
    { title: '8. Intellectual Property Rights', body: 'The Platform and all its original content, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof), are owned by Dwelling, its licensors, or other providers of such material and are protected by Canadian and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws. These Terms grant you a limited, non-exclusive, non-transferable, revocable license to access and use the Platform for your personal, non-commercial use only. You must not reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any of the material on our Platform, except as generally and ordinarily permitted through the Platform\'s functionality. Any unauthorized use of the Platform\'s content or intellectual property is strictly prohibited and may result in legal action.' },
    { title: '9. Privacy Policy and Data Collection', body: 'Your privacy is paramount to us. By using the Platform, you consent to the collection, use, and processing of your personal information, including your email address, account activity, search queries, and usage data, as described in our Privacy Policy. This data is collected primarily to provide, maintain, and improve the functionality and user experience of the Platform. Search queries are processed in real-time to generate analyses and are not retained beyond the immediate generation of reports, unless explicitly saved by the user. We are committed to not selling your personal information to third parties. Any Cerebras AI API key you provide, if applicable, is stored in an encrypted format and is used solely for the purpose of forwarding your requests to the Cerebras AI service on your behalf. Our full Privacy Policy, which is incorporated by reference into these Terms, provides further details on our data handling practices.' },
    { title: '10. Third-Party Services and External Data Sources', body: 'The Platform integrates with, and relies upon, various third-party services and external data sources to provide its functionality. These include, but are not limited to, data providers such as Realtor.ca/CREA, Statistics Canada, OpenStreetMap, Open-Meteo, and Cerebras AI, as well as infrastructure providers like Turso and Vercel. The Company is not responsible for the accuracy, reliability, availability, or privacy practices of any third-party service or data source. We do not endorse, and are not affiliated with, any of these third parties unless explicitly stated. Your use of third-party services may be subject to their respective terms and conditions and privacy policies, and you are encouraged to review them independently.' },
    { title: '11. Subscription, Billing, and Refund Policy', body: 'Access to certain advanced features or higher usage limits on the Platform may require a paid subscription. All subscriptions are charged in advance, typically in Canadian dollars, as specified at the time of purchase. Subscriptions will automatically renew at the end of each billing cycle unless cancelled by you prior to the renewal date. Analysis availability under paid plans is subject to platform capacity, fair use limitations, and our internal policies, and does not constitute a guarantee of any specific volume or uninterrupted service. All payments are non-refundable, except at the sole discretion of the Company and as required by applicable law. Any refund requests must be submitted in writing to the contact information provided herein.' },
    { title: '12. Account Suspension and Termination', body: 'The Company reserves the right, at its sole discretion, to suspend or terminate your account and access to the Platform, with or without notice, for any reason, including but not limited to: (a) breach of these Terms; (b) suspected fraudulent, abusive, or illegal activity; (c) requests by law enforcement or other government agencies; (d) unexpected technical issues or problems; or (e) extended periods of inactivity. Upon termination, your right to use the Platform will immediately cease. All provisions of these Terms which by their nature should survive termination shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, indemnity, and limitations of liability.' },
    { title: '13. Indemnification', body: 'You agree to defend, indemnify, and hold harmless the Company, its affiliates, licensors, and service providers, and its and their respective officers, directors, employees, contractors, agents, licensors, suppliers, successors, and assigns from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys\' fees) arising out of or relating to your violation of these Terms or your use of the Platform, including, but not limited to, your reliance on any Platform content for financial or real estate decisions, your User Contributions, any use of the Platform\'s content, services, and products other than as expressly authorized in these Terms, or your use of any information obtained from the Platform.' },
    { title: '14. Governing Law and Dispute Resolution', body: 'These Terms and any dispute or claim arising out of or in connection with them or their subject matter or formation (including non-contractual disputes or claims) shall be governed by and construed in accordance with the laws of the Province of Ontario and the federal laws of Canada applicable therein, without giving effect to any choice or conflict of law provision or rule. Any legal suit, action, or proceeding arising out of, or related to, these Terms or the Platform shall be instituted exclusively in the courts of the Province of Ontario, although we retain the right to bring any suit, action, or proceeding against you for breach of these Terms in your country of residence or any other relevant country. You irrevocably waive any and all objections to the exercise of jurisdiction over you by such courts and to venue in such courts. Prior to initiating any formal legal action, you agree to engage in good-faith negotiation to resolve any dispute. If negotiation fails, disputes shall be resolved by binding arbitration administered by a mutually agreed-upon arbitration service in Ottawa, Ontario, in accordance with its commercial arbitration rules. You expressly waive any right to participate in any class action lawsuit or class-wide arbitration against the Company.' },
    { title: '15. Severability and Entire Agreement', body: 'If any provision of these Terms is found by a court or other tribunal of competent jurisdiction to be invalid, illegal, or unenforceable for any reason, such provision shall be eliminated or limited to the minimum extent such that the remaining provisions of the Terms will continue in full force and effect. These Terms, together with any documents expressly incorporated by reference, constitute the sole and entire agreement between you and Dwelling regarding the Platform and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Platform.' },
