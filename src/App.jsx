  ...
  return (
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{
          flex: 1, overflowY: 'scroll', padding: '28px',
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Always show auth modal if not logged in and not loading */}
      {(!user && !authLoading) && <AuthModal onClose={() => {}} onAuth={handleAuth} />}
      {showAuth && user === null && <AuthModal onClose={() => setShowAuth(false)} onAuth={handleAuth} />}
