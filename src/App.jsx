  ...
  return (
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        maxWidth: 760, width: '100%', height: '85vh',
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 28px', borderBottom: '2px solid #ffffff', flexShrink: 0 }}>
          ...
          <button onClick={onClose} style={{
            ...
            fontFamily: MONO, fontSize: 12, padding: '8px 14px', cursor: 'crosshair',
        ...
        <div style={{ flex: 1, overflowY: 'scroll', padding: '28px', fontFamily: "'Inter', sans-serif", fontSize: 13, color: 'rgba(255,255,255,0.7)', lineHeight: 1.8 }}>
          ...
          {[
            { title: '1. Definitions', body: `"Platform" means the Dwelling website and all associated services. "Company" refers to Dwelling. "User" refers to any individual accessing the Platform. "Content" means all data, analyses, and outputs generated by the Platform.` },
    ...
    <footer style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap' }}>
        ...
        <button onClick={onTermsClick} style={{
          background: 'transparent', border: 'none', fontFamily: MONO, fontSize: 11,
          color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase', letterSpacing: '0.1em',
...
export default function App() {
  ...
  const checkAndIncrementUsage = async () => {
    ...
    const { data } = await supabase.from('users').update(updates).eq('id', user.id).select().maybeSingle()
