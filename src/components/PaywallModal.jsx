  ...
  if (view === "notify") {
    return (
      <Overlay onClose={onClose}>
        ...
        >
          Payments are launching shortly. Drop your email and you'll be first to know — and first to lock in the early
          price.
        </p>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 28 }}>
        <span
          style={{
            fontFamily: "'Barlow',sans-serif",
            fontSize: 13,
            color: annual ? "rgba(255,255,255,0.35)" : "#fff",
            fontWeight: 400,
            transition: "color 0.2s",
          }}
        >
      ...
      <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", alignItems: "center" }}>
        ...
        >
          ...
          >
              ...
              {PRO_FEATURES.map((f) => (
                <div key={f.text} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 11 }}>
                  ...
                  <span
                    style={{
                      fontFamily: "'Barlow',sans-serif",
                      fontWeight: f.highlight ? 500 : 300,
                      fontSize: 12,
                      color: f.highlight ? "#e2f5ff" : "rgba(255,255,255,0.65)",
                      lineHeight: 1.4,
                    }}
                  >
                    {f.text}
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!upgrading) e.currentTarget.style.opacity = "0.88"
              }}
            ...
            <div style={{ textAlign: "center", marginTop: 8 }}>
              ...
              >
                Cancel anytime · Test cards accepted
              </span>
            </div>
          </div>
        </div>
        ...
        <div
          style={{
            ...
            borderRadius: 25.5,
            background:
              "linear-gradient(135deg, rgba(251,191,36,0.4) 0%, rgba(245,158,11,0.3) 50%, rgba(180,83,9,0.25) 100%)",
                ...
                <div key={text} style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 8 }}>
                  ...
                  <span
                    style={{
                      ...
                      fontSize: 11,
                      color: hl ? "#fef3c7" : "rgba(255,255,255,0.55)",
                      lineHeight: 1.4,
                    }}
                  >
                    {text}
            ...
            <button
              onClick={async () => {
                try {
                  const token = await getAuthToken()
                  if (!token) {
                    window.location.href = "mailto:01dominique.c@gmail.com?subject=Dwelling Business Plan"
                    return
                  }
                  const res = await fetch("/api/auth", {
                    method: "POST",
