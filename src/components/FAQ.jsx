...
const FAQ_ITEMS = [
  ...
  { q: 'Is Dwelling free to use?', a: 'Yes — completely free, no subscription required. Create an account and run unlimited analyses. To use live AI generation, bring your own API key from a supported provider: Cerebras (free tier), Groq (free tier), OpenRouter, OpenAI, or Anthropic. Keys are stored in your browser and never charged by Dwelling.' },
  ...
  { q: 'Does Dwelling store my searches?', a: 'Search inputs are processed in real time. If you\'re signed in, completed reports are auto-saved to your account so you can revisit them. Your AI provider key is stored in your browser only and is never retained on Dwelling servers.' },
